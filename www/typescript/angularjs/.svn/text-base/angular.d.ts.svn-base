...
declare module ng {
    ...
    interface IQService {
        ...
        all(promises: { [id: string]: IPromise<any>; }): IPromise<any[]>;
    /**
...
interface IPromise<T> {
    ...
    then<TResult>(successCallback: (promiseValue: T) => TResult, errorCallback?: (reason: any) => any, notifyCallback?: (state: any) => any): IPromise<TResult>;
